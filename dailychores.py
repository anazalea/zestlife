...
def end_day(lemonade_game):
    ...
    daily_report = [
        ...
        f"    lemons: {ls.lemonstock.current_units - ls._day_start_lemon:.2f}",
        f"    sugar [g]: {ls.sugarstock.current_units - ls._day_start_sugar:.2f}",
        f"    ice [cubes]: {ls.icestock.current_units - ls._day_start_ice:.2f}",
        "",
        f"Current inventory:",
        f"    lemons: {ls.lemonstock.current_units:.2f}",
        f"    sugar [g]: {ls.sugarstock.current_units:.2f}",
        f"    ice [cubes]: {ls.icestock.current_units:.2f}",
        "",
        f"Wages deducted: ${total_wage:.2f}",
        "",
        f"Net revenue: ${ls.account_balance - ls._day_start_acc_balance:.2f}",
    ]
